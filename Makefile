# Copyright(c) 2019 DSiSc Group. All Rights Reserved.
# 
...
help:
	@echo 'Management commands for DSiSc/wasm-cdt:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building wasm-cdt ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/wasm-cdt/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/wasm-cdt/version.BuildDate=${BUILD_DATE}" ./...
